...
dr = str(r'C:\Users\Karl.schutt\Desktop\pastas-realtime')
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #


sys.path.append(dr+'/Real time functionalities')
from Project_rt import * # Pastas project version with forecast function
sys.path.append(dr+'/Tools')
from Eref_to_epot import calc_epot # Function to calculate potential evaporation from reference evaporation
